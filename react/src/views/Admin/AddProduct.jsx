...
function AddProduct() {
  ...
  return (
      ...
      {id &&<button type="submit"  className=" btn btn-danger " style={{marginLeft:'360px'}}>Update Product</button>}
      {!id && <button type="submit"  className=" btn btn-danger " style={{marginLeft:'360px'}}>Create Product</button>}
    </form>
                    )}
                  </div>
                 </>
